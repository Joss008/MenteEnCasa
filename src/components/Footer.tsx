...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer id="contacto" className="bg-[#607D8B] text-[#FAF7F2] pt-16 pb-12 border-t border-[#78909C]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#78909C]">

          {/* Brand Info */}
          <div className="lg:col-span-5 space-y-4 text-left">
            <div className="bg-[#FAF7F2] p-3 rounded-2xl border border-[#78909C] inline-block">
            ...
            <div className="pt-2 flex flex-col gap-2 text-xs text-[#EBE4D8]">
              ...
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-[#90A4AE] shrink-0" aria-hidden="true" />
          ...
          <div className="lg:col-span-4 space-y-4 text-left">
            ...
            <div className="space-y-3 text-xs text-[#EBE4D8]">
              ...
              <button
                ...
                className="px-5 py-3 rounded-full bg-[#90A4AE] text-white font-bold text-xs hover:bg-[#78909C] transition-all inline-flex items-center gap-2 shadow-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-[#90A4AE] btn-press cursor-pointer"
              >
