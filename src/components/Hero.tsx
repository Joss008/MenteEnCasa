          ...
          >
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 max-w-md mx-auto sm:mx-0 sm:max-w-none">
              <button
                ...
                className="btn-press min-h-14 px-6 sm:px-7 py-3.5 sm:py-4 rounded-full bg-[#3B5242] hover:bg-[#2C3E33] text-white font-bold text-[0.95rem] sm:text-base transition-colors duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-3"
              >
              ...
              <button
                ...
                className="btn-press min-h-[52px] px-6 py-3.5 sm:py-4 rounded-full bg-[#F3EFE6] border border-[#E2DACB] hover:border-[#3B5242] text-[#2C3E33] font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2 hover:bg-[#EBE4D8]"
              >
